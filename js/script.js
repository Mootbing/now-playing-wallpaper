...
function UpdateClock() {
  ...
  */
  ...
  // if(_12hour)
  timeEl.innerHTML= dayArr[d.getDay()] + ", " + new Intl.DateTimeFormat('en-GB',{'day':'2-digit','month':'2-digit','year':'2-digit'}).format(d).replace(',','') + ", " + `${new Intl.DateTimeFormat('en-US',{'hour':'2-digit','minute':'2-digit','hour12':true}).format(d)}`;
  // else
